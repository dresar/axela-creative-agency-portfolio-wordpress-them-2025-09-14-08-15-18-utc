...
<div class="menu-area menu_type_<?php echo esc_attr($main_menu_type);?>" <?php echo wp_kses($menu_bg_color, 'axela');?>>    
    <div class="menu_one">
            ...
            <div class="col-cell header-logo">
                <?php 
                 if (!empty( $axela_option['wplogo_mobile_rt']['url'] ) ) { ?>
                  <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img <?php echo wp_kses($mobile_logo_height, 'axela');?> src="<?php echo esc_url( $axela_option['wplogo_mobile_rt']['url']); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"></a>
                <?php }else{
            ...
            <div class="col-cell header-quote">            
                ...
                if($rs_top_search != 'hide'){
                  if(!empty($axela_option['off_search']) || ($rs_top_search == 'show') ): ?>
               ...
               if($rs_offcanvas != 'hide'):
                  if(!empty($axela_option['off_canvas']) || ($rs_offcanvas == 'show') ): ?>
                  <div class="sidebarmenu-area text-right desktop">
                    <?php if(!empty($axela_option['off_canvas']) || ($rs_offcanvas == 'show') ){
                            $off = $axela_option['off_canvas'];
