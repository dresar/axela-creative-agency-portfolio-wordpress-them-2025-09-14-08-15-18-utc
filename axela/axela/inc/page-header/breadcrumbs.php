...
<?php 
  ...
  if($post_meta_data == ''){
    if(!empty($axela_option['page_banner_main']['url'])):
      $post_meta_data = $axela_option['page_banner_main']['url'];
    
    else: {
      $post_meta_data2 = !empty($axela_option['breadcrumb_bg_color'])? $axela_option['breadcrumb_bg_color'] : '';
    }
    endif;
  }  
