<?php 
    ...
    if($post_meta_data == ''){
        if(!empty($axela_option['course_banner']['url'])):
        $post_meta_data = $axela_option['course_banner']['url'];
        endif;
    }  
    ...
    if(!empty($axela_option['show_banner__course'])):
      $post_meta_data = $axela_option['show_banner__course'];
    endif;
?>
...
<div class="reactheme-breadcrumbs  porfolio-details">
    ...
    <div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url($post_meta_data); ?>')"> 
        ...
        <?php } elseif(!empty($axela_option['course_banner']['url'])){ 
        $course_banner = $axela_option['course_banner']['url'];?>
