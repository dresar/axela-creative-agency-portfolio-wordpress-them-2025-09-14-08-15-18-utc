...
<div id="reactheme-blog" class="reactheme-blog blog-page">
   <?php
       ...
       if (!empty($axela_option['blog-layout']) || !is_active_sidebar('sidebar-1')) {
           $blog_layout = !empty($axela_option['blog-layout']) ? $axela_option['blog-layout'] : '';
           $blog_grid   = !empty($axela_option['blog-grid']) ? $axela_option['blog-grid'] : '';
                                ...
                                <div class="full-blog-content">
                                    <div class="user-info">
                                        ...
                                        <div class="single-info">
                                            ...
                                            <span>  <?php echo esc_html__('by', 'axela');?>  
                                                <?php if(!empty($axela_option['blog-author-post'])){
                                                if ($axela_option['blog-author-post'] == 'show'): 
                                        ...
                                        <div class="single-info cat">
                                            ...
                                            <span> <?php if(!empty($axela_option['blog-category'])){
                                                if($axela_option['blog-category'] == 'show'){
                                                    if(get_the_category()):
                                                        the_category(', ');                                                 
                                                endif;
                                                    }
                                    ...
                                    <div class="blog-desc">   
                                        <?php echo axela_custom_excerpt(25);?>                                     
                                    </div>                                     
                                    <?php                                     
                                          
                                        if(!empty($axela_option['blog_readmore'])):?>
                                            <div class="blog-button">
                                                <a href="<?php the_permalink();?>">
                                                    <?php echo esc_html($axela_option['blog_readmore']); ?>
                                                </a>
                                            </div>
                                    <?php endif; ?>
                            </div>
